                        ...
                        <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2">
                            <CardContent className="pt-6">
                                <div className="pt-6 lg:px-6">
                                    <svg className="w-full text-[var(--cc-blue-700)] dark:text-[var(--cc-blue-700)]" viewBox="0 0 386 123" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <rect width="386" height="123" rx="10" />
                                        <g clipPath="url(#clip0_0_106)">
                                            <circle className="text-[var(--cc-blue-700)] dark:text-[var(--cc-blue-700)]" cx="29" cy="29" r="15" fill="currentColor" />
                                        ...
                                        />
                                        <path
                                            className="text-[var(--cc-blue-700)] dark:text-[var(--cc-blue-700)]"
                                        ...
                                        <defs>
                                            <linearGradient id="paint0_linear_0_106" x1="3" y1="60" x2="3" y2="123" gradientUnits="userSpaceOnUse">
                                                <stop className="text-[var(--cc-blue-700)]/15 dark:text-[var(--cc-blue-700)]/35" stopColor="currentColor" />
                                                <stop className="text-[var(--cc-blue-700)]" offset="1" stopColor="currentColor" stopOpacity="0.103775" />
                                            </linearGradient>
                                    ...
                                    <svg className="w-full sm:w-[150%] text-[var(--cc-blue-700)] dark:text-[var(--cc-blue-700)]" viewBox="0 0 366 231" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <defs>
                                            <linearGradient id="paint0_linear_0_705" x1="0.85108" y1="0.947876" x2="0.85108" y2="230.114" gradientUnits="userSpaceOnUse">
                                                <stop className="text-[var(--cc-blue-700)]/15 dark:text-[var(--cc-blue-700)]/35" stopColor="currentColor" />
                                                <stop className="text-[var(--cc-blue-700)]" offset="1" stopColor="currentColor" stopOpacity="0.01" />
                                            </linearGradient>
                                        </defs>
                                    </svg>
                                </div>
